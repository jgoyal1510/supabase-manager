...
const PAProfilesPage = () => {
  ...
  useEffect(() => {
    const fetchProfiles = async () => {
      try {
        setLoading(true);
        const response = await fetch('/api/rcm/pa/profiles');
  ...
  const handleInsertTestData = async () => {
    ...
    try {
      ...
      const profilesResponse = await fetch('/api/rcm/pa/profiles');
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">PA Profiles Management</h1>
